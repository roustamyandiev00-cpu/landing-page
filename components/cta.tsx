      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          ...
          <p className="mt-4 text-lg text-primary-foreground/80 max-w-2xl mx-auto">
            Download de app en maak vandaag nog je eerste offerte. 14 dagen gratis, geen verplichtingen.
          </p>
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              ...
              {isInstalled ? "App Geïnstalleerd" : "Download App"}
            </Button>
            <Button
              size="lg"
              variant="outline"
              className="text-base px-8 h-14 bg-transparent border-primary-foreground/30 text-primary-foreground hover:bg-primary-foreground/10 hover:text-primary-foreground"
            >
              Bekijk demo
